<?php
    ...
    {
        $data = $_GET['search'];
        $sql = "SELECT * FROM cliente WHERE id_usuario LIKE '%$data%' or nome LIKE '%$data%' or email LIKE '%$data%' ORDER BY id DESC";
    }
    else
    {
        $sql = "SELECT * FROM cliente ORDER BY id_usuario DESC";
    }
