<?php
    ...
    {
        $data = $_GET['search'];
        $sql = "SELECT * FROM produtos WHERE id_produto LIKE '%$data%' or nome LIKE '%$data%' or email LIKE '%$data%' ORDER BY id DESC";
    }
    else
    {
            ...
            <tbody>
                <?php
                    while($user_data = mysqli_fetch_assoc($result)) {
                        ...
                        echo "<td>
                        <a class='btn btn-sm btn-primary' href='edit.php?id=$user_data[id_produto]' title='Editar'>
